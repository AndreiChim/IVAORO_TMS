...
mysqli_select_db($con,$db_name) or die('Cannot select database: '. mysqli_error($con));
    ...
    $sql = "SELECT * FROM $tbl_name WHERE Trainer = 'NA'";
...
$sql = "SELECT * FROM $tbl_name WHERE ReportStatus = 'Pending' AND Trainer = '$trainer'";

$result = mysqli_query($con,$sql) or die(mysqli_error($con));

?>

<h4>My assumed requests</h4>
...
<table id='mytrainings' class='admintrainings'>
    ...
    <?php
    $sql = "SELECT * FROM $tbl_name WHERE ReportStatus = 'Pending' AND Trainer != '$trainer' AND Trainer != 'NA'";
...
<!-- SECOND TABLE -->
    ...
    <h4>Other active training requests</h4>
